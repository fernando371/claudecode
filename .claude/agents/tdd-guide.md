...
- Not mocking external dependencies (databases, APIs, etc.)
...
- Writing implementation before the failing test exists
- Skipping tests because "it's a simple change"
- Tests that always pass regardless of implementation
- Test file with no assertions
- Mocking the thing being tested

**Remember**: A test written after the fact is documentation. A test written before is a specification. Only the specification drives correct design.
